...
def logIn():
    url = 'https://api-xingtian.lianjieabs.com/entry/login'
...
# 查询合同模板
def getContractMode():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/'+ missionuuid
...
def uploadContractFile1():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/command/upload'
...
def getData2():
    global getdata2
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template'
...
# 配置第2个合同
def setContract2():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata2)
    parameter = {
...
# 配置第3个合同
def setContract3():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata3)
    parameter = {
...
# 配置第4个合同
def setContract4():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata4)
...
# 配置第5个合同
def setContract5():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata5)
    parameter ={"xtSignRoles": [{"roleId": "DirectObligor", "roleType": "notifier"},
                     {"roleId": "Creditor", "roleType": "receiver"}],
...
# 配置第6个合同
def setContract6():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata6)
...
# 配置第7个合同
def setContract7():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata7)
...
# 配置第8个合同
def setContract8():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata8)
...
# 配置第9个合同
def setContract9():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata9)
...
# 配置第11个合同
def setContract11():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata11)
...
# 配置第12个合同
def setContract12():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata12)
...
# 配置第13个合同
def setContract13():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata13)
...
# 配置第14个合同
def setContract14():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata14)
...
# 配置第15个合同
def setContract15():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/entity/template/{}'.format(getdata15)
...
def checkMission():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/command/check/mission'
    parameter = {"signMissionUuid":"{}".format(missionuuid)}
    r = requests.post(url=url, data=json.dumps(parameter), headers=header)
    if r.json()["code"] == "SUCCESS":
        print("验证成功,请进入页面继续完成后续操作")
        print("https://api-xingtian.lianjieabs.com/entry/login")
    else:
        print("提交失败")
        print(json.dumps(r.json(), sort_keys=True, indent=2, ensure_ascii=False))

def checkPassMission():
    url = 'https://api-xingtian.lianjieabs.com/xingtian/contract/preview/command/check-pass/mission/{}'.format(missionuuid)
    r = requests.get(url=url, data=None, headers=header)
    if r.json()["code"] == "SUCCESS":
