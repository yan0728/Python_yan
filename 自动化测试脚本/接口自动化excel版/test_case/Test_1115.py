...
import requests
from 自动化测试脚本.接口自动化excel版.uti import ReadExcel_1115
...
class Test_Case():
    ...
    def Test_1115(self):
        exceldata = ReadExcel_1115.ReadExcel.getExcelData(1) #调用读取excel的方法
