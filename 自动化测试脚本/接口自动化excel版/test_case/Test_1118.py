...
import requests
from 自动化测试脚本.接口自动化excel版.uti import ReadExcel_1118
...
class Test_Case():
    ...
    def Test_1118(self):
        exceldata = ReadExcel_1118.ReadExcel.getExcelData(1) #调用读取excel的方法
